...
if (strlen($_SESSION['vpmsaid']==0)) {
  ...
  {
    $adminid=$_SESSION['vpmsuid'];
    $aname=$_POST['adminname'];
  $mobno=$_POST['contactnumber'];
  
     $query=mysqli_query($con, "update tbluser set Name ='$aname', MobileNumber='$mobno' where ID='$adminid'");
    if ($query) {
...
?>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input class=" form-control" id="adminname" name="Name" type="text" value="<?php  echo $row['UserName'];?>"></div>
                                    </div>
                                    <div class="row form-group">
