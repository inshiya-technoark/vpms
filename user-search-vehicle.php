...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal" name="search">
    ...
    echo $msg;
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Search By Registration Number</label></div>
...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4> 
               ...
               <?php
$ret=mysqli_query($con,"select *from   tblvehicle where RegistrationNumber like '$sdata%'");
...
?>
                ...
                <tr>
                  ...
                  <td><a href="user-view-incomingvehicle.php?viewid=<?php echo $row['ID'];?>">View</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
} } else { ?>
