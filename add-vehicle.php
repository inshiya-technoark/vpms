...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblvehicle(ParkingNumber,VehicleCategory,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber, ParkingCharge) value('$parkingnumber','$catename','$vehcomp','$vehreno','$ownername','$ownercontno', '$pcharge')");
    if ($query) {
    ...
    echo $msg;
              ...
              ?>    
                  ...
                  <?php } ?> 
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Parking Charge</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="pcharge" name="pcharge" class="form-control" placeholder="Parking Charge" required="true"></div>
                                    </div>
