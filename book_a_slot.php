                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="book_a_slot.php">Vehicle</a></li>
    ...
    echo $msg;
              ...
              ?>    
                  ...
                  <?php } ?> 
                                   ...
                                   <p style="text-align: center;"> <a href = "payment.html"><button type="submit" class="btn btn-primary btn-sm" name="submit" >Book</button></a></p>
                                </form>
                            </div>
