...
<body class="bg-img">
    ...
    <div class="form-wrap">
		<div class="tabs">
			<h3 class="signup-tab"><a class="active" href="#signup-tab-content">Admin</a></h3>
			<h3 class="login-tab"><a href="#login-tab-content">User</a></h3>
		</div><!--.tabs-->
		...
		<div class="tabs-content">
			<div id="signup-tab-content" class="active">
				<form class="signup-form" action="" method="post">
                    ...
                    <input type="submit" class="button" value="Admin Login" name="login">
				</form><!--.login-form-->
				<div class="help-text">
			...
			<div id="login-tab-content">
				...
				<div class="help-text">
					<p><a href="signup.php">New Here? Create An Account</a></p>
				</div><!--.help-text-->
